...
Go SDK封装了Bmob REST API API，但并不包含功能封装，如果需要调用具体的功能，请参考官方REST API API开发文档[http://docs.bmob.cn/data/Restful/b_developdoc/doc/index.html](http://docs.bmob.cn/data/Restful/b_developdoc/doc/index.html)
